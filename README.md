...
| [`developer-atlas`](developer-atlas/SKILL.md) | Library behavior, API contracts, errors, bug fixes, and migrations | primary-source discovery, targeted extraction, version/release verification |
...
For an isolated Codex discovery trial of `developer-atlas`, see the [manual test guide and natural-language queries](tests/developer-atlas.md).
